function DataFiltered = HLaplacian(Data, Points, Channels)
    %HLaplacian function to apply High Laplacian Filter on EEG Signal
    % Inputs:
    ...
    for n = 1:length(Channels)                 % For each Channel
        ...
        [Dist, Idx] = sort(Dist);
        NeighborCandid = Points(:, Idx(10:21));
        CandidIdx = Idx(10:21);
        CandidDist = Dist(10:21);
